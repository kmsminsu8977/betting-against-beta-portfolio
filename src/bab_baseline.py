...
PROJECT = {"analysis_type": "bab", "category": "Factor Investing", "columns": ["asset", "beta", "expected_excess_return", "volatility"], "methods": ["베타 중앙값을 기준으로 저베타/고베타 leg를 나누고 각 leg를 베타 1로 스케일한다.", "스케일된 기대 초과수익 차이를 BAB spread의 첫 진단 지표로 둔다.", "수익률과 베타는 BAB leg 구성을 설명하는 교육용 합성 패널이다."], "module_name": "bab_baseline", "objective": "저베타 자산을 레버리지하고 고베타 자산을 축소하는 BAB 아이디어를 단순 수치로 검증한다.", "question": "저베타 그룹을 시장 베타 1로 스케일하면 고베타 그룹 대비 기대 초과수익 스프레드가 남는가?", "rows": [["LOW_BETA_UTILITY", 0.62, 0.041, 0.11], ["STABLE_CONSUMER", 0.74, 0.046, 0.13], ["QUALITY_HEALTH", 0.82, 0.052, 0.14], ["CYCLICAL_AUTO", 1.18, 0.061, 0.24], ["HIGH_BETA_TECH", 1.36, 0.067, 0.29], ["LEVERED_FINANCE", 1.52, 0.072, 0.33]], "sample_name": "asset_beta_panel.csv", "title_en": "Betting Against Beta Portfolio", "title_ko": "Betting Against Beta 포트폴리오"}
