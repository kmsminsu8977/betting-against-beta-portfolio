...
이 문서는 `betting-against-beta-portfolio` 컨텐츠를 만들 때 참고해야 할 로컬 source inventory입니다. 새 코드, 데이터 예시, 문서, 산출물을 만들 때는 이 파일과 `AGENTS.md`를 먼저 확인합니다.

## 프로젝트 식별

- 프로젝트명: Betting Against Beta 포트폴리오 (Betting Against Beta Portfolio)
- 연구 카테고리: Factor Investing
- 핵심 질문: 저베타 그룹을 시장 베타 1로 스케일하면 고베타 그룹 대비 기대 초과수익 스프레드가 남는가?
...
- 시장 베타 추정과 저베타/고베타 leg 구분
- 베타 1 기준 스케일링
- BAB spread와 레버리지 제약 해석
